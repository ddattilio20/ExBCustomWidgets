...
import { type CurrentLayer, type LayersInfo } from '../../config'
...
export default class LayersInfos extends React.PureComponent<Props, State> {
  ...
  onAnalysisOrderChanged = (newSortedAnalysis) => {
    ...
    this.setState({
      ...
      this.props.onLayersInfoSettingsUpdated(this.state.addedLayerAnalysis, activeEditIdx !== -1 ? activeEditIdx : this.props.analysisIndex, this.props.editCurrentLayer.layerDsId, this.props.editCurrentLayer.analysisType)
    })
  }
